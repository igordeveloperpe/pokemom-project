...
//     await TestBed.configureTestingModule({
//       declarations: [SelectPokemomComponent],
//       imports: [FormsModule, CommonModule , HttpClientModule],
//       providers: [{ provide: SendPokemomService, useValue: sendPokemomServiceSpy }],
//     }).compileComponents();
...
//     await TestBed.configureTestingModule({
//       imports: [
//         SelectPokemomComponent, // Como standalone, adicione no imports
//         // HttpClientModule, // Necessário para o HttpClient no serviço
//         FormsModule, // Necessário para o ngModel no template
//       ],
//       providers: [
//         provideHttpClient(),
